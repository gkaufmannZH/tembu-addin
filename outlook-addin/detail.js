/* Tembu Contact Intelligence – detail.js v20260629q */
...
async function fetchEmails(since, top = 100) {
  ...
  try {
    ...
    showDiag(`js:20260629q | E-Mail: ${diagMode} | roh:${diagRaw} → gefiltert:${diagFiltered} | name="${_contactName}" email="${_contactEmail || '—'}" | seit:${sinceDate}`);
