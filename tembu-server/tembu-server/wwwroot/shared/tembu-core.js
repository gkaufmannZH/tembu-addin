...
const TCore = (() => {
  ...
  // Sprachneutrale Enum-Codes im JSON-Schema (Rendering übersetzt sie erst zur Anzeige)
  function aiJsonSchemaEnums() {
    return { sentiment: 'positive|neutral|negative', status: 'open|done' };
  }

  function aiLanguageInstruction() {
    return typeof TI18n !== 'undefined' ? TI18n.t('common.aiLanguageInstruction') : '';
  }
